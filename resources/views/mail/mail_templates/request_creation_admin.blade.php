...
<body>
    ...
    <table class="yiv7050401279MsoNormalTable" style="width: 100.0%;" border="1" width="100%" cellspacing="3"
        ...
        <tbody>
            ...
            <tr style="min-height: 22.5pt;">
                <td style="border: solid #DFE0E2 1.0pt; padding: .75pt .75pt .75pt .75pt; min-height: 22.5pt;">
                    <p class="yiv7050401279MsoNormal"><span style="font-size: 9.0pt;">&nbsp; <strong>Phone
                            </strong></span></p>
                </td>
                <td style="border: solid #DFE0E2 1.0pt; padding: .75pt .75pt .75pt .75pt; min-height: 22.5pt;">
                    <p class="yiv7050401279MsoNormal"><span style="font-size: 9.0pt;">&nbsp; &nbsp;{{
                            $requestData['pInfo_phoneNumber']
                            }}</span>
                    </p>
                </td>
            </tr>
            ...
            <tr style="min-height: 22.5pt;">
                ...
                <td style="border: solid #DFE0E2 1.0pt; padding: .75pt .75pt .75pt .75pt; min-height: 22.5pt;">
                    <p class="yiv7050401279MsoNormal"><span style="font-size: 9.0pt;">&nbsp;
                            &nbsp;{{ $requestData['purpose_purpose']}}</span></p>
                </td>
            </tr>
            <tr style="min-height: 22.5pt;">
                <td style="border: solid #DFE0E2 1.0pt; padding: .75pt .75pt .75pt .75pt; min-height: 22.5pt;">
                ...
                <td style="border: solid #DFE0E2 1.0pt; padding: .75pt .75pt .75pt .75pt; min-height: 22.5pt;">
                    <p class="yiv7050401279MsoNormal"><span style="font-size: 9.0pt;">&nbsp;
                            &nbsp;{{$requestData['address_city']}}</span></p>
                </td>
            </tr>
            ...
            <tr style="min-height: 22.5pt;">
                ...
                <td style="border: solid #DFE0E2 1.0pt; padding: .75pt .75pt .75pt .75pt; min-height: 22.5pt;">
                    <p class="yiv7050401279MsoNormal"><span style="font-size: 9.0pt;">&nbsp;
                            &nbsp;{{$requestData['address_area']}}</span></p>
                </td>
            </tr>
            <tr style="min-height: 22.5pt;">
                <td style="border: solid #DFE0E2 1.0pt; padding: .75pt .75pt .75pt .75pt; min-height: 22.5pt;">
                ...
                <td style="border: solid #DFE0E2 1.0pt; padding: .75pt .75pt .75pt .75pt; min-height: 22.5pt;">
                    <p class="yiv7050401279MsoNormal"><span style="font-size: 9.0pt;">&nbsp;
                            &nbsp;{{$requestData['address_location']}}</span></p>
                </td>
            </tr>
            ...
            <tr style="min-height: 22.5pt;">
                ...
                <td style="border: solid #DFE0E2 1.0pt; padding: .75pt .75pt .75pt .75pt; min-height: 22.5pt;">
                    <p class="yiv7050401279MsoNormal"><span style="font-size: 9.0pt;">&nbsp;
                            &nbsp;{{$requestData['extra_info_description']}}</span></p>
                </td>
            </tr>
            <tr style="min-height: 22.5pt;">
                <td style="border: solid #DFE0E2 1.0pt; padding: .75pt .75pt .75pt .75pt; min-height: 22.5pt;">
