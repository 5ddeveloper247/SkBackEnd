...
<section id="deliveries">
    <div class="contain-fluid">
        ...
        {{-- edit property popup --}}
        <div>
        {{-- <div class="popup lg edit-data-popup" data-popup="edit-data-popup" id="edit-data-popup"> above corrected div  --}}
            <div class="table_dv">
                    ...
                    <div class="contain">
                        <div class="_inner editor_blk">
                            ...
                            <div id="Inspection" class="tab-pane fade active in">
                                ...
                                <div class="blk">
                                    <form action="{{ route('admin.property.main.submission.edit') }}"
                                        class="propertySubmissionForm_edit" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <fieldset id="personal_info_tab_edit">
                                            <div class="form_row row">
                                                ...
                                                <div class="col-xs-6">
                                                    ...
                                                    <div class="form_blk">
                                                        <input type="text" name="pInfo_firstName_edit"
                                                            id="pInfo_firstName_edit" class="text_box"
                                                ...
                                                <div class="col-xs-6">
                                                    ...
                                                    <div class="form_blk">
                                                        <input type="text" name="pInfo_lastName_edit"
                                                            id="pInfo_lastName_edit" class="text_box"
                                                ...
                                                <div class="col-xs-6">
                                                    ...
                                                    <div class="form_blk">
                                                        <input type="email" name="pInfo_email_edit"
                                                            id="pInfo_email_edit" class="text_box"
                                            ...
                                            <div class="btn_blk form_btn text-right">
                                                <button type="button"
                                                    class="site_btn personal_info_continue_btn_edit long "
                                                    id="p-info_continue_btn_edit">Continue</button>
                                            </div>
                                        </fieldset>

                                        {{-- Purpose info tabl --}}
                                        <fieldset id="purpose_tab_edit">
                                            <div class="form_row row">
                                                ...
                                                <div class="col-sm-6 col-xs-12">
                                                    ...
                                                    <div class="form_blk">
                                                        <select name="purpose_commercial_edit"
                                                            id="purpose_commercial_edit" class="text_box selectpicker"
                                                            data-container="body">
                                            ...
                                            <div class="btn_blk form_btn text-right">
                                                <button type="button"
                                                    class="site_btn long simple border purpose_back_btn prev_btn_edit">Back</button>
                                                <button type="button"
                                                    class="site_btn purpose_continue_btn_edit long ">Continue</button>
                                            </div>
                                        </fieldset>

                                        {{-- Address info tabl --}}

                                        <fieldset id="address_tab_edit">
                                            <div class="form_row row">
                                                <div class="col-sm-4 col-xs-12">
                                                    <h6>City<sup>*</sup></h6>
                                                    <div class="form_blk">
                                                        <select name="address_city_edit" id="address_city_edit"
                                                            class="text_box selectpicker" data-container="body">
                                                ...
                                                <div class="col-sm-4 col-xs-12">
                                                    <h6>Area<sup>*</sup></h6>
                                                    <div class="form_blk">
                                                        <select name="address_area_edit" id="address_area_edit"
                                                            class="text_box selectpicker" data-container="body">
                                                ...
                                                <div class="col-sm-4 col-xs-12">
                                                    <h6>Phase<sup>*</sup></h6>
                                                    <div class="form_blk">
                                                        <select name="address_phase_edit" id="address_phase_edit"
                                                            class="text_box selectpicker" data-container="body">
                                                ...
                                                <div class="col-sm-4 col-xs-12">
                                                    ...
                                                    <div class="form_blk">
                                                        <select name="address_sector_edit" id="address_sector_edit"
                                                            class="text_box selectpicker" data-container="body">
                                                ...
                                                <div class="col-sm-4 col-xs-12">
                                                    ...
                                                    <div class="form_blk">
                                                        <select name="address_address_edit" id="address_address_edit"
                                                            class="text_box selectpicker" data-container="body">
                                            ...
                                            <div class="btn_blk form_btn text-right">
                                                <button type="button"
                                                    class="site_btn long simple border address_back_btn_edit prev_btn"
                                                    id="address_back_btn_edit">Back</button>
                                                <button type="button" class="site_btn address_continue_btn_edit long "
                                                    id="address_continue_btn_edit">Continue</button>
                                            </div>
                                        </fieldset>

                                        {{-- Property detail --}}
                                        <fieldset id="property_detail_tab_edit">
                                            <div class="form_row row">
                                                <div class="col-sm-4 col-xs-12">
                                                    <h6>Plot No<sup>*</sup></h6>
                                                    <div class="form_blk">
                                                        <select name="propertyDetail_plot_num_edit"
                                                            id="propertyDetail_plot_num_edit"
                                                            class="text_box selectpicker" data-container="body">
                                                ...
                                                <div class="col-sm-4 col-xs-12">
                                                    <h6>Area<sup>*</sup></h6>
                                                    <div class="form_blk">
                                                        <select name="propertyDetail_area_edit"
                                                            id="propertyDetail_area_edit" class="text_box selectpicker"
                                                            data-container="body">
                                                ...
                                                <div class="col-sm-4 col-xs-12">
                                                    <div class="form_blk">
                                                        <div>
                                                            ...
                                                            <div class="form_blk">
                                                                <input type="number"
                                                                    name="propertyDetail_area_unit_edit"
                                                ...
                                                <div class="col-sm-4 col-xs-12">
                                                    ...
                                                    <div class="form_blk">
                                                        <select name="propertyDetail_bedrooms_edit"
                                                            id="propertyDetail_bedrooms_edit"
                                                            class="text_box selectpicker" data-container="body">
                                                            <option value="1">1</option>
                                                            <option value="2"> 2</option>
                                                            <option value="3"> 3</option>
                                                ...
                                                <div class="col-sm-4 col-xs-12">
                                                    ...
                                                    <div class="form_blk">
                                                        <select name="propertyDetail_bathrooms_edit"
                                                            id="propertyDetail_bathrooms_edit"
                                                            class="text_box selectpicker" data-container="body">
                                                            <option value="1">1</option>
                                                            <option value="2"> 2</option>
                                                            <option value="3"> 3</option>
                                            ...
                                            <div class="btn_blk form_btn text-right">
                                                <button type="button"
                                                    class="site_btn long simple border property_detail_back-btn_edit prev_btn">Back</button>
                                                <button type="button"
                                                    class="site_btn property_detail_continue_btn_edit long ">Continue</button>
                                            </div>
                                        </fieldset>

                                        {{-- Extra information tabl --}}
                                        <fieldset id="extra_info_tab_edit">
                                            ...
                                            <div class="contain">
                                                        ...
                                                        <div class="col-xs-12">
                                                            ...
                                                            <div class="form_blk">
                                                                <input type="text" name="extra_info_title"
                                                                    id="extra_info_title_edit" class="text_box"
                                                        ...
                                                        <div class="col-xs-12">
                                                            ...
                                                            <div class="form_blk">
                                                                <input type="text" name="extra_info_postingas"
                                                                    id="extra_info_postingas_edit" class="text_box"
                                                        ...
                                                        <div class="col-xs-12">
                                                            ...
                                                            <div class="form_blk">
                                                                <input type="number" name="extra_info_mobile_edit"
                                                                    id="extra_info_mobile_edit" class="text_box"
                                                        ...
                                                        <div class="col-xs-12">
                                                            ...
                                                            <div class="form_blk">
                                                                <input type="number" name="extra_info_landline_edit"
                                                                    id="extra_info_landline_edit" class="text_box"
                                                                    placeholder="eg: 285432584452">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-xs-12">
                                                            <div class="uploader_blk text_box">
                                                                ...
                                                                <div class="btn_blk text-center">
                                                                    <input type="hidden" id="existingFiles"
                                                                        name="existing_files">
                                                                    <input type="file" id="fileInput_edit"
                                                                        name="photos_edit[]" multiple
                                                                        style="display:none;">
                                                ...
                                                <div class="btn_blk text-center">
                                                    <button type="button"
                                                        class="site_btn extra_info_back-btn_edit long light prev_btn"><img
                                                            src="{{ asset('/images/arrow-left-sm.svg')}}" alt="">
                                                        Back</button>
                                                    <button type="button"
                                                        class="site_btn extra_info_continue-btn_edit long">Continue</button>
                                                </div>
                                            </div>
                                        </fieldset>
                                        ...
                                        <fieldset id="amenities_tab_edit">
                                            <div class="form_row row">
                                                ...
                                                <div class="col-xs-12">
                                                    ...
                                                    <div class="form_blk">
                                                        <ul class="check_lst flex">
                                                            <li>
                                                                <label>
                                                                    <input type="checkbox" name="check_Possesion_edit"
                                                                        id="check_Possesion_edit">
                                                                    <span>Possesion</span>
                                                                </label>
                                                            </li>
                                                            <li>
                                                                <label>
                                                                    <input type="checkbox" name="checkk_Balloted_edit"
                                                                        id="check_Balloted_edit">
                                                                    <span>Balloted</span>
                                                                </label>
                                                            </li>
                                                            <li>
                                                                <label>
                                                                    <input type="checkbox" name="check_Balloted_edit"
                                                                        id="check_Sewerage_edit">
                                                                    <span>Balloted</span>
                                                                </label>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <label>
                                                                    <input type="checkbox" name="check_SuiGas_edit"
                                                                        id="check_SuiGas_edit">
                                                                    <span>Sui Gas</span>
                                                                </label>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <label>
                                                                    <input type="checkbox"
                                                                        name="check_NearbyHospitals_edit"
                                                            ...
                                                            <li>
                                                                <label>
                                                                    <input type="checkbox"
                                                                        name="check_NearbyShoppingMalls_edit"
                                                            ...
                                                            <li>
                                                                <label>
                                                                    <input type="checkbox"
                                                                        name="check_NearbyRestaurant_edit"
                                                            ...
                                                            <li>
                                                                <label>
                                                                    <input type="checkbox"
                                                                        name="check_NearbyPubicTransportService_edit"
                                                            ...
                                                            <li>
                                                                <label>
                                                                    <input type="checkbox"
                                                                        name="check_CentralAirConditioning_edit"
                                                            ...
                                                            <li>
                                                                <label>
                                                                    <input type="checkbox"
                                                                        name="check_DoubleGlazedWindows_edit"
                                                            ...
                                                            <li>
                                                                <label>
                                                                    <input type="checkbox"
                                                                        name="check_CentralHeating_edit"
                                                            ...
                                                            <li>
                                                                <label>
                                                                    <input type="checkbox"
                                                                        name="check_BroadbandInternetAccess_edit"
                                                            ...
                                                            <li>
                                                                <label>
                                                                    <input type="checkbox"
                                                                        name="check_SatelliteorCableTVReady_edit"
                                            ...
                                            <div class="btn_blk form_btn text-right">
                                                ...
                                                <button type="button"
                                                    class="site_btn amenities_continue_btn_edit long ">Continue</button>
                                            </div>
                                        </fieldset>

                                        {{-- Done tabl --}}
                                        <fieldset id="done_tab_edit">
